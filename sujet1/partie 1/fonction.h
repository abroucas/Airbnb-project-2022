 ...
 * 
 * @param nomFichier nombre de lignes du fichier
 * @return FILE* tableau de Logements
 */
...
/**
 * @brief interroge l'utilisateur pour définir les paramètres du logement étudié x
 * 
 * @param x logement étudié
 */
...
/**
 * @brief calcule le prix d'un logement en faisant la moyenne des prix des k logements les plus proches de lui
 * 
...
/**
 * @brief calcule la distance entre le logement étudié et les autres logements puis calcule le prix d'un logement en faisant la moyenne des prix des k logements les plus proches de lui
 * 
 * @param ligne nombre de lignes du tableau (= nombre de logements)
 * @param tab tableau de logements
 * @param x logement étudié
 * @return float prix du logement étudié
 */
